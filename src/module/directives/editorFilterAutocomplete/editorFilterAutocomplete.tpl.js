...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('module/directives/editorFilterAutocomplete/editorFilterAutocomplete.html',
    ...
    '        <div data-ng-show="vm.preloadedData" class="autocomplete-input-wrapper form-control">\n' +
    '            <div data-ng-show="vm.preloadedData" class="selected-values">\n' +
    '                <div data-ng-repeat="acItem in vm.selectedValues" class="autocomplete-item">{{acItem[vm.filter_search]}}<span data-ng-click="vm.removeFromSelected()" class="remove-from-selected">×</span></div>\n' +
    '            </div>\n' +
