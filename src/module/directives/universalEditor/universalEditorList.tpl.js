...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('module/directives/universalEditor/universalEditorList.html',
    ...
    '                        </ul>\n' +
    '                        <div class="page-size col-lg-2 col-md-2 col-sm-2 col-xs-2">\n' +
    '                            <div class="dropup">\n' +
    '                                <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle">{{vm.currentPage}}&nbsp<span class="caret"></span></button>\n' +
