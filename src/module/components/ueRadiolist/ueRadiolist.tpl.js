...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('module/components/ueRadiolist/ueRadiolist.html',
    ...
    '                <label data-ng-repeat="item in vm.optionValues" data-ng-class="{\'radiodisabled\': vm.readonly}" class="radio-inline">\n' +
    '                    <input type="radio" data-ng-disabled="vm.readonly" data-ng-model="vm.fieldValue[i]" value="{{item[vm.field_id]}}"/><span ng-bind="item[vm.field_search]"></span>\n' +
