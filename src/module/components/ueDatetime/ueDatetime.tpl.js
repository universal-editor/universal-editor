...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('module/components/ueDatetime/ueDatetime.html',
    ...
    '                <input date-time="" name="{{vm.fieldName}}" data-ng-disabled="vm.readonly" ng-model="vm.fieldValue[$index]" view="date" format="{{vm.format || \'YYYY-MM-DD HH:mm:ss\'}}" class="form-control input-sm"/><span class="input-group-btn">\n' +
    ...
    '            <input date-time="" name="{{vm.fieldName}}" data-ng-disabled="vm.readonly" ng-model="vm.fieldValue" view="date" format="{{vm.format || \'YYYY-MM-DD HH:mm:ss\'}}" class="form-control input-sm"/>\n' +
    '        </div>\n' +
    '    </div>\n' +
