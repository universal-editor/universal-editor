...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('module/components/ueTable/ueTable.html',
    ...
    '            <!--(ng-repeat="button in vm.listHeaderBar track by $index")-->\n' +
    ...
    '                            <ue-button-edit data-ng-if="link.type == \'edit\'" data-entity-subtype="{{item[vm.subType]}}" data-entity-id="{{item[vm.idField]}}" data-button-label="{{link.label}}" data-button-request="{{link.request}}"></ue-button-edit>\n' +
    '                            <ue-button-delete data-ng-if="link.type == \'delete\'" data-entity-id="{{item[vm.idField]}}" data-button-label="{{link.label}}" data-button-request="{{link.request}}" data-button-class="context"></ue-button-delete>\n' +
    '                            <ue-button-open data-ng-if="link.type == \'open\'" data-entity-id="{{item[vm.idField]}}" data-button-label="{{link.label}}" data-button-request="{{link.request}}"></ue-button-open>\n' +
