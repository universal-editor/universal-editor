...
Объект конфигурации можно получить с бекенда и передать для инициализации приложения, например:
...
| alertNotSaved | bool | Параметр отвечает за вывод сообщения об изменение в карточке редактирования, если пользовател хочет уйти с карточки или закрыть вкладку не сохранив изменения.   | - | false |
| assetsPath | string | Параметр указывает на расположение файлов редактора | - | '/assets/universal-editor' |
