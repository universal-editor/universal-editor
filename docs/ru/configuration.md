...
| alertNotSaved | bool | Параметр отвечает за вывод сообщения об изменение в карточке редактирования, если пользовател хочет уйти с картоки или закрыть вкладку не сохранив изменения.   | - | false |
