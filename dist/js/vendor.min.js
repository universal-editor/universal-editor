...
angular.module("ui.tinymce",[]).value("uiTinymceConfig",{}).directive("uiTinymce",["$rootScope","$compile","$timeout","$window","$sce","uiTinymceConfig",function(e,t,n,i,r,o){o=o||{};var u="ui-tinymce";return o.baseUrl&&(tinymce.baseURL=o.baseUrl),{require:["ngModel","^?form"],priority:599,link:function(a,c,s,d){function m(e){e?(f(),$&&$.getBody().setAttribute("contenteditable",!1)):(f(),$&&!$.settings.readonly&&$.getBody().setAttribute("contenteditable",!0))}function f(){$||($=tinymce.get(s.id))}if(i.tinymce){var l,$,v=d[0],g=d[1]||null,y={debounce:!0},b=function(t){var n=t.getContent({format:y.format}).trim();n=r.trustAsHtml(n),v.$setViewValue(n),e.$$phase||a.$digest()};s.$set("id",u+"-"+(new Date).valueOf()),l={},angular.extend(l,a.$eval(s.uiTinymce));var p=function(e){var t;return function(i){n.cancel(t),t=n(function(){return function(e){e.isDirty()&&(e.save(),b(e))}(i)},e)}}(400),h={setup:function(t){t.on("init",function(){v.$render(),v.$setPristine(),v.$setUntouched(),g&&g.$setPristine()}),t.on("ExecCommand change NodeChange ObjectResized",function(){return y.debounce?void p(t):(t.save(),void b(t))}),t.on("blur",function(){c[0].blur(),v.$setTouched(),e.$$phase||a.$digest()}),t.on("remove",function(){c.remove()}),o.setup&&o.setup(t,{updateView:b}),l.setup&&l.setup(t,{updateView:b})},format:l.format||"html",selector:"#"+s.id};angular.extend(y,o,l,h),n(function(){y.baseURL&&(tinymce.baseURL=y.baseURL);var e=tinymce.init(y);e&&"function"==typeof e.then?e.then(function(){m(a.$eval(s.ngDisabled))}):m(a.$eval(s.ngDisabled))}),v.$formatters.unshift(function(e){return e?r.trustAsHtml(e):""}),v.$parsers.unshift(function(e){return e?r.getTrustedHtml(e):""}),v.$render=function(){f();var e=v.$viewValue?r.getTrustedHtml(v.$viewValue):"";$&&$.getDoc()&&($.setContent(e),$.fire("change"))},s.$observe("disabled",m),a.$on("$tinymce:refresh",function(e,n){var i=s.id;if(angular.isUndefined(n)||n===i){var r=c.parent(),o=c.clone();o.removeAttr("id"),o.removeAttr("style"),o.removeAttr("aria-hidden"),tinymce.execCommand("mceRemoveEditor",!1,i),r.append(t(o)(a))}}),a.$on("$destroy",function(){f(),$&&($.remove(),$=null)})}}}}]);
!function(){"use strict";angular.module("universalEditor.MosUploader",["universalEditor.MosUploader.templates","minicolors","datePicker","checklist-model","angularMoment","ngFileUpload","pascalprecht.translate"])}(),function(){"use strict";function e(e,i,l,r,d){var n,a,t=this;t.ssid=void 0,this.sessionIsOpen=function(){return void 0!==t.ssid},this.removeSessionId=function(){t.ssid=void 0},this.getSessionId=function(){return t.ssid},this.closeSession=function(){t.sessionIsOpen()&&e({method:"POST",url:l.uploaderServiceUrl+"/session/"+t.ssid+"/close"}).then(function(){t.ssid=void 0})},this.openSession=function(e,i,l){if(!t.sessionIsOpen())return a(e,i,l)},this.uploadFile=function(e,i,l,r){return t.sessionIsOpen()?n(e,i,l,r):a(i,l,r).then(function(){return n(e,i,l,r)})},a=function(l,r,d){var n=i.defer();return e({method:"POST",url:d+"/session",data:{group:r,service_id:l}}).then(function(i){t.ssid=i.data.session_id,e.defaults.headers.common["Uploader-Session"]=t.ssid,n.resolve()},function(e){n.reject()}),n.promise},n=function(e,l,d,n){var a=i.defer();return r.upload({url:n+"/file/upload",data:{file:e,session_id:t.ssid,group:d,service_id:l}}).then(function(e){a.resolve(e)},function(e){a.reject(e)}),a.promise},d.$on("uploader:remove_session",function(i,l){e.defaults.headers.common["Uploader-Session"]=void 0,t.removeSessionId()})}angular.module("universalEditor.MosUploader").service("MosUploader",e),e.$inject=["$http","$q","configData","Upload","$rootScope"]}(),function(){"use strict";function e(e,i,l,r,d){var n,a=this;n=e.parentField?e.parentFieldIndex?e.parentField+"_"+e.parentFieldIndex+"_"+e.fieldName:e.parentField+"_"+e.fieldName:e.fieldName,a.url=e.field.url,a.fieldName=e.field.name,a.fieldDisplayName=e.field.label,a.inputValue={},a.readonly=e.field.readonly||!1,a.hint=e.field.hint||!1,a.required=e.field.required||!1,a.formShowStatus=!0,e.$parent.vm.error=[],a.parentFieldIndex=e.parentFieldIndex||!1,a.uploaderServiceId=e.field.serviceId||!1,a.uploaderServiceGroup=e.field.serviceGroup||!1,a.multiname=e.field.multiname||!1,a.processing=!1,a.uploaderServiceGroup||e.$emit("editor:field_error","Для поля "+n+" не указан параметр service_group"),a.uploaderServiceId||e.$emit("editor:field_error","Для поля "+n+" не указан параметр service_id"),e.field.hasOwnProperty("multiple")&&e.field.multiple===!0?(a.multiple=!0,a.fieldValue=[]):a.multiple=!1,a.parentFieldIndex&&(a.fieldValue=r.getFieldValue(e.parentField,e.parentFieldIndex,e.field.name)||a.fieldValue),i.addFieldController(this),this.getFieldValue=function(){var i={},l=a.fieldValue;return e.parentField?a.parentFieldIndex?(i[e.parentField]=[],i[e.parentField][a.parentFieldIndex]={},i[e.parentField][a.parentFieldIndex][a.fieldName]=l):(i[e.parentField]={},i[e.parentField][a.fieldName]=l):i[a.fieldName]=l,i},this.getInitialValue=function(){var i={};return e.parentField?a.multiple?(i[e.parentField]={},i[e.parentField][a.fieldName]=[]):(i[e.parentField]={},i[e.parentField][a.fieldName]=void 0):a.multiple?i[a.fieldName]=[]:i[a.fieldName]=void 0,i},this.getReadableFileSize=function(e){var i=-1,l=[" kB"," MB"," GB"," TB","PB","EB","ZB","YB"];do e/=1024,i++;while(e>1024);return Math.max(e,.1).toFixed(1)+l[i]},e.$on("editor:entity_loaded",function(i,l){return"new"===l.editorEntityType?void(a.fieldValue=a.multiple?[]:void 0):a.parentFieldIndex?void(a.multiple?a.fieldValue=r.getFieldValue(e.parentField,e.parentFieldIndex,e.field.name)||[""]:a.fieldValue=r.getFieldValue(e.parentField,e.parentFieldIndex,e.field.name)||""):void(e.parentField?a.fieldValue=l[e.parentField][e.field.name]:a.fieldValue=l[e.field.name])}),e.$on("editor:api_error_field_"+n,function(i,l){angular.isArray(l)?angular.forEach(l,function(i){e.$parent.vm.error.indexOf(i)<0&&e.$parent.vm.error.push(i)}):e.$parent.vm.error.indexOf(l)<0&&e.$parent.vm.error.push(l)}),e.$on("$destroy",function(){i.deleteFieldController(a),a.parentFieldIndex&&r.fieldDestroy(e.parentField,e.parentFieldIndex,e.field.name,a.fieldValue)}),e.$watch(function(){return a.fieldValue},function(){e.$parent.vm.error=[],a.multiple?a.formShowStatus=!0:a.fieldValue&&null!==a.fieldValue?a.formShowStatus=!1:a.formShowStatus=!0}),a.upload=function(i){if(e.$parent.vm.error=[],!i)return d.reject();if(e.field.hasOwnProperty("maxSize")&&i.size>e.field.maxSize)return e.$parent.vm.error.push("Максимальный допустимый размер файла - "+a.getReadableFileSize(e.field.maxSize)),d.reject();if(e.field.hasOwnProperty("minSize")&&i.size<e.field.minSize)return e.$parent.vm.error.push("Минимальный допустимый размер файла - "+a.getReadableFileSize(e.field.minSize)),d.reject();if(e.field.hasOwnProperty("typesAllowed")){var r=i.name.split(".");if(r.length<=1)return e.$parent.vm.error.push("Загрузка файлов без расширений запрещена"),d.reject();if(e.field.typesAllowed.indexOf(r[r.length-1])<0)return e.$parent.vm.error.push('Данный тип файлов в формате " '+r[r.length-1]+' " не разрешен для загрузки. Допустимые типы файлов: '+e.field.typesAllowed.join(",")),d.reject()}var n=new FileReader,t=d.defer();return n.readAsDataURL(i),n.onload=function(e){a.processing=!0,l.uploadFile(i,a.uploaderServiceId,a.uploaderServiceGroup,a.url).then(function(e){a.multiple?a.fieldValue.push({src:e.data.src}):a.fieldValue={src:e.data.src},a.processing=!1,t.resolve()},function(e){console.log(e),a.processing=!1,t.reject()})},t.promise},a.uploadFiles=function(e){l.sessionIsOpen()?angular.forEach(e,function(e){a.upload(e,a.uploaderServiceId,a.uploaderServiceGroup)}):l.openSession(a.uploaderServiceId,a.uploaderServiceGroup,a.url).then(function(){angular.forEach(e,function(e){a.upload(e,a.uploaderServiceId,a.uploaderServiceGroup)})})},a.deleteValue=function(e){e="undefined"!=typeof e?e:-1,e>=0?a.fieldValue.splice(e,1):a.fieldValue=void 0}}angular.module("universalEditor.MosUploader").controller("EditorFieldFileController",e),e.$inject=["$scope","EditEntityStorage","MosUploader","ArrayFieldStorage","$q"]}(),function(){"use strict";function e(e){function i(e,i,l,r){i.on("$destroy",function(){e.$destroy()})}return{restrict:"A",replace:!0,scope:!0,template:e.get("module/directives/editorFieldFile/editorFieldFile.html"),controller:"EditorFieldFileController",controllerAs:"vm",link:i}}angular.module("universalEditor.MosUploader").directive("editorFieldUploaderFile",e),e.$inject=["$templateCache"]}(),function(e){try{e=angular.module("universalEditor.MosUploader.templates")}catch(i){e=angular.module("universalEditor.MosUploader.templates",[])}e.run(["$templateCache",function(e){e.put("module/directives/editorFieldFile/editorFieldFile.html",'\n<div>\n    <div class="files-field-value col-lg-6 col-md-6 col-sm-6 col-xs-6">\n        <div data-ng-if="vm.multiple">\n            <div data-ng-repeat="fileItem in vm.fieldValue" class="field-item-wrapper"><a data-ng-href="{{fileItem.src}}" target="_blank" class="file-item">{{fileItem.src}}</a>\n                <div data-ng-click="vm.deleteValue($index)" class="btn btn-primary btn-sm">Удалить файл</div>\n            </div>\n        </div>\n        <div data-ng-if="!vm.multiple">\n            <div data-ng-if="vm.fieldValue" class="field-item-wrapper"><a data-ng-href="{{vm.fieldValue.src}}" target="_blank" class="file-item">{{vm.fieldValue.src}}</a>\n                <div data-ng-click="vm.deleteValue()" class="btn btn-primary btn-sm">Удалить файл</div>\n            </div>\n        </div>\n    </div>\n    <div class="files-field-wrapper col-lg-6 col-md-6 col-sm-6 col-xs-6">\n        <div data-ng-if="!vm.readonly &amp;&amp; vm.formShowStatus">\n            <div data-ng-if="vm.multiple">\n                <div data-ngf-select="vm.uploadFiles($files)" multiple="multiple" data-ng-class="{ processing : vm.processing}" class="btn btn-primary btn-sm">Выбрать файл\n                    <div data-ng-show="vm.processing" class="loader-search-wrapper">\n                        <div class="loader-search">Загрузка</div>\n                    </div>\n                </div>\n            </div>\n            <div data-ng-if="!vm.multiple">\n                <div data-ngf-select="vm.upload($file)" data-ng-class="{ processing : vm.processing}" class="btn btn-primary btn-sm">Выбрать файл\n                    <div data-ng-show="vm.processing" class="loader-search-wrapper">\n                        <div class="loader-search">Загрузка</div>\n                    </div>\n                </div>\n            </div>\n            <div data-ngf-drop="vm.uploadFiles($files)" data-ngf-multiple="vm.multiple" data-ngf-drag-over-class="\'file-over\'" class="file-drop">Для загрузки перетащите файлы сюда...</div>\n            <div data-ngf-no-file-drop="">File Drag/Drop is not supported for this browser</div>\n        </div>\n    </div>\n</div>')}])}(),function(){"use strict";function e(e,i,l,r){var d,n=this;d=e.parentField?e.parentFieldIndex?e.parentField+"_"+e.parentFieldIndex+"_"+e.fieldName:e.parentField+"_"+e.fieldName:e.fieldName,n.url=e.field.url,n.fieldName=e.field.name,n.fieldDisplayName=e.field.label,n.inputValue={},n.readonly=e.field.readonly||!1,n.hint=e.field.hint||!1,n.required=e.field.required||!1,n.formShowStatus=!0,e.$parent.vm.error=[],n.parentFieldIndex=e.parentFieldIndex||!1,n.uploaderServiceId=e.field.serviceId||!1,n.uploaderServiceGroup=e.field.serviceGroup||!1,n.multiname=e.field.multiname||!1,n.processing=!1,n.uploaderServiceGroup||e.$emit("editor:field_error","Для поля "+d+" не указан параметр serviceGroup"),n.uploaderServiceId||e.$emit("editor:field_error","Для поля "+d+" не указан параметр serviceId"),e.field.hasOwnProperty("multiple")&&e.field.multiple===!0?(n.multiple=!0,n.fieldValue=[]):n.multiple=!1,n.parentFieldIndex&&(n.fieldValue=r.getFieldValue(e.parentField,e.parentFieldIndex,e.field.name)||n.fieldValue),i.addFieldController(this),this.getFieldValue=function(){var i={},l=n.fieldValue;return e.parentField?n.parentFieldIndex?(i[e.parentField]=[],i[e.parentField][n.parentFieldIndex]={},i[e.parentField][n.parentFieldIndex][n.fieldName]=l):(i[e.parentField]={},i[e.parentField][n.fieldName]=l):i[n.fieldName]=l,i},this.getInitialValue=function(){var i={};return e.parentField?n.multiple?(i[e.parentField]={},i[e.parentField][n.fieldName]=[]):(i[e.parentField]={},i[e.parentField][n.fieldName]=void 0):n.multiple?i[n.fieldName]=[]:i[n.fieldName]=void 0,i},this.getReadableFileSize=function(e){var i=-1,l=[" kB"," MB"," GB"," TB","PB","EB","ZB","YB"];do e/=1024,i++;while(e>1024);return Math.max(e,.1).toFixed(1)+l[i]},e.$on("editor:entity_loaded",function(i,l){return"new"===l.editorEntityType?void(n.fieldValue=n.multiple?[]:void 0):n.parentFieldIndex?void(n.multiple?n.fieldValue=r.getFieldValue(e.parentField,e.parentFieldIndex,e.field.name)||[""]:n.fieldValue=r.getFieldValue(e.parentField,e.parentFieldIndex,e.field.name)||""):void(e.parentField?n.fieldValue=l[e.parentField][e.field.name]:n.fieldValue=l[e.field.name])}),e.$on("editor:api_error_field_"+d,function(i,l){angular.isArray(l)?angular.forEach(l,function(i){e.$parent.vm.error.indexOf(i)<0&&e.$parent.vm.error.push(i)}):e.$parent.vm.error.indexOf(l)<0&&e.$parent.vm.error.push(l)}),e.$on("$destroy",function(){i.deleteFieldController(n),n.parentFieldIndex&&r.fieldDestroy(e.parentField,e.parentFieldIndex,e.field.name,n.fieldValue)}),e.$watch(function(){return n.fieldValue},function(){e.$parent.vm.error=[],n.multiple?n.formShowStatus=!0:n.fieldValue&&null!==n.fieldValue?n.formShowStatus=!1:n.formShowStatus=!0}),n.upload=function(i){if(e.$parent.vm.error=[],i){if(e.field.hasOwnProperty("maxSize")&&i.size>e.field.maxSize)return void e.$parent.vm.error.push("Максимальный допустимый размер файла - "+n.getReadableFileSize(e.field.maxSize));if(e.field.hasOwnProperty("minSize")&&i.size<e.field.minSize)return void e.$parent.vm.error.push("Минимальный допустимый размер файла - "+n.getReadableFileSize(e.field.minSize));if(e.field.hasOwnProperty("typesAllowed")){var r=i.name.split(".");if(r.length<=1)return void e.$parent.vm.error.push("Загрузка файлов без расширений запрещена");if(e.field.typesAllowed.indexOf(r[r.length-1])<0)return void e.$parent.vm.error.push('Данный тип файлов в формате " '+r[r.length-1]+' " не разрешен для загрузки. Допустимые типы файлов: '+e.field.typesAllowed.join(","))}var d=new FileReader,a=new Image;d.readAsDataURL(i),d.onload=function(r){a.src=r.target.result,a.onload=function(){var e=this.width,r=this.height;n.processing=!0,l.uploadFile(i,n.uploaderServiceId,n.uploaderServiceGroup,n.url).then(function(i){n.multiple?n.fieldValue.push({src:i.data.src,width:e,height:r}):n.fieldValue={src:i.data.src,width:e,height:r},n.processing=!1},function(e){n.processing=!1,console.log(e)})},a.onerror=function(){e.$parent.vm.error.push("Данный тип файла не является изображением")}}}},n.uploadFiles=function(e){l.sessionIsOpen()?angular.forEach(e,function(e){n.upload(e,n.uploaderServiceId,n.uploaderServiceGroup)}):l.openSession(n.uploaderServiceId,n.uploaderServiceGroup,n.url).then(function(){angular.forEach(e,function(e){n.upload(e,n.uploaderServiceId,n.uploaderServiceGroup)})})},n.deleteValue=function(e){e="undefined"!=typeof e?e:-1,e>=0?n.fieldValue.splice(e,1):n.fieldValue=void 0}}angular.module("universalEditor.MosUploader").controller("EditorFieldImageController",e),e.$inject=["$scope","EditEntityStorage","MosUploader","ArrayFieldStorage"]}(),function(){"use strict";function e(e){function i(e,i,l,r){i.on("$destroy",function(){e.$destroy()})}return{restrict:"A",replace:!0,scope:!0,template:e.get("module/directives/editorFieldImage/editorFieldImage.html"),controller:"EditorFieldImageController",controllerAs:"vm",link:i}}angular.module("universalEditor.MosUploader").directive("editorFieldUploaderImage",e),e.$inject=["$templateCache"]}(),function(e){try{e=angular.module("universalEditor.MosUploader.templates")}catch(i){e=angular.module("universalEditor.MosUploader.templates",[])}e.run(["$templateCache",function(e){e.put("module/directives/editorFieldImage/editorFieldImage.html",'\n<div>\n    <div class="images-field-value col-lg-6 col-md-6 col-sm-6 col-xs-6">\n        <div data-ng-if="vm.multiple">\n            <div data-ng-repeat="imageItem in vm.fieldValue" class="field-image-wrapper">\n                <div class="image-inner-wrap"><img data-ng-src="{{imageItem.src}}" class="image-item"/>\n                    <div data-ng-click="vm.deleteValue($index)" class="btn btn-primary btn-sm">Удалить файл</div>\n                </div>\n            </div>\n        </div>\n        <div data-ng-if="!vm.multiple">\n            <div data-ng-if="vm.fieldValue" class="field-image-wrapper">\n                <div class="image-inner-wrap"><img data-ng-src="{{vm.fieldValue.src}}" class="image-item"/>\n                    <div data-ng-click="vm.deleteValue()" class="btn btn-primary btn-sm">Удалить файл</div>\n                </div>\n            </div>\n        </div>\n    </div>\n    <div class="images-field-wrapper col-lg-6 col-md-6 col-sm-6 col-xs-6">\n        <div data-ng-if="!vm.readonly &amp;&amp; vm.formShowStatus">\n            <div data-ng-if="vm.multiple">\n                <div data-ngf-select="vm.uploadFiles($files)" multiple="multiple" data-ng-class="{ processing : vm.processing}" class="btn btn-primary btn-sm">Выбрать файл\n                    <div data-ng-show="vm.processing" class="loader-search-wrapper">\n                        <div class="loader-search">Загрузка</div>\n                    </div>\n                </div>\n            </div>\n            <div data-ng-if="!vm.multiple">\n                <div data-ngf-select="vm.upload($file)" data-ng-class="{ processing : vm.processing}" class="btn btn-primary btn-sm">Выбрать файл\n                    <div data-ng-show="vm.processing" class="loader-search-wrapper">\n                        <div class="loader-search">Загрузка</div>\n                    </div>\n                </div>\n            </div>\n            <div data-ngf-drop="vm.uploadFiles($files)" data-ngf-pattern="\'image/*\'" data-ngf-multiple="vm.multiple" data-ngf-drag-over-class="\'file-over\'" class="file-drop">Для загрузки перетащите изображения сюда...</div>\n            <div data-ngf-no-file-drop="">File Drag/Drop is not supported for this browser</div>\n        </div>\n    </div>\n</div>')}])}();